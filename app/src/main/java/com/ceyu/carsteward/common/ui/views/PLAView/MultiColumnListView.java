...
package com.ceyu.carsteward.common.ui.views.PLAView;
...
//    private int mColumnBetween = getContext().getResources().getDimensionPixelSize(R.dimen.tribe_gallery_item_between);
...
//            mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingLeft, getContext().getResources().getDimensionPixelSize(R.dimen.common_block_view_margin_top));
//            mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.PinterestLikeAdapterView_plaColumnPaddingRight, getContext().getResources().getDimensionPixelSize(R.dimen.common_block_view_margin_top));
            a.recycle();
        }
