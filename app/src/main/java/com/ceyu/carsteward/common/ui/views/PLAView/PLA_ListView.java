...
public class PLA_ListView extends PLA_AbsListView {
     ...
     * the choice mode has been set to {@link #} or
     * {@link #}.
     * 
     * @param position
     ...
     * valid if the choice mode has been set to {@link #} or
     * {@link #}.
     * 
     * @param position
     ...
     * choice mode has been set to {@link #}.
     * 
     ...
     * the choice mode has not been set to {@link #}.
     * 
     ...
     * choice mode has not been set to {@link #}.
     * 
    ...
    /**
     * Returns the set of checked items ids. The result is only valid if the
     * choice mode has not been set to {@link #} and the adapter
