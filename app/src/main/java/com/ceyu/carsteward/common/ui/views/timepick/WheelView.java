...
public class WheelView extends View {
    ...
    private static final int[] SHADOWS_COLORS = new int[]{0x333333, 0x333333,
            0x333333};
    /**
     ...
     */
    private final int ITEM_OFFSET = TEXT_SIZE / 1;
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = getResources().getDimensionPixelSize(R.dimen.maintain_order_wheel_text_size);
    }
