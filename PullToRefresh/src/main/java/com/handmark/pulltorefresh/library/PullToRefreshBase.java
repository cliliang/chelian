...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    @Override
    public void onRefreshComplete(boolean anmi) {
        if (isRefreshing()) {
            setState(State.RESET, anmi);
        }
    }
    ...
    // Temp solution 20150213: Refresh header layout in resume to avoid bug#1981,
    // can't show title icon after back from share
     ...
     */
    protected void onReset(boolean anim) {
        mIsBeingDragged = false;
